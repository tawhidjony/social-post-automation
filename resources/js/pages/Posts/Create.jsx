            ...
            <div className="max-w-7xl mx-auto py-10 px-4 grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <form onSubmit={handleSubmit} className="bg-white p-6 rounded-xl shadow border space-y-6">
                    ...
                    <div>
                        ...
                        {errors.social_account_ids && <p className="text-red-500 text-xs mt-1">{errors.social_account_ids}</p>}
                    </div>
                    ...
                    <div>
                        ...
                        <input type="file" multiple accept="image/*" onChange={handleMediaChange} className="w-full text-sm" />
                    </div>
                ...
                <div className="bg-gray-50 p-6 rounded-xl border flex flex-col items-center justify-center">
                    <h3 className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-4">Facebook Post Live Preview</h3>
                    <div className="w-full max-w-sm bg-white rounded-xl shadow border overflow-hidden">
                        ...
                        <div className="p-4">
                            <p className="text-sm text-gray-800 whitespace-pre-wrap">{data.content || 'Your content preview will appear here...'}</p>
                        </div>
                        {previews.length > 0 && (
                            <div className="grid grid-cols-1 gap-1 border-t">
                                <img src={previews[0]} alt="Preview" className="w-full h-48 object-cover" />
                            </div>
                        )}
                    </div>
                </div>
